...
const STATUS_MESSAGES = [
  { threshold: 15, text: "Initializing Core System Modules..." },
  { threshold: 35, text: "Constructing 3D Interactive Canvas..." },
  { threshold: 60, text: "Mounting Artificial Intelligence Models..." },
  { threshold: 80, text: "Pre-rendering Visual Environments..." },
  { threshold: 95, text: "Synapsing Interface Channels..." },
  { threshold: 100, text: "Decryption Complete. Welcome." }
];

const Preloader = ({ onComplete }) => {
  const [progress, setProgress] = useState(0);
  const [status, setStatus] = useState("Initializing Core System Modules...");
  ...
  useEffect(() => {
    ...
    const animateProgress = (timestamp) => {
      ...
      if (elapsed < duration) {
        ...
        setProgress(100);
        setStatus("Decryption Complete. Welcome.");
    ...
    >
      ...
      <div className="loader-visual-group">
        ...
        <div className="loader-core">
          <Cpu className="loader-core-icon" />
        </div>
      </div>
      ...
      <div className="loader-content-panel">
        ...
        <p className="loader-subtitle">Neural Interview Simulator</p>
